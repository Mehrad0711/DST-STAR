...
from utils.data_utils import Processor
...
def main(args):
    ...
    best_epoch = 0
    test_res = model_evaluation(model, data_raw, tokenizer, slot_meta, label_list,
                                best_epoch, is_gt_p_state=False, pred_set_name=args.pred_set_name)
